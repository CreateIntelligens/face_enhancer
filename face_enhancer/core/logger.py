...
from face_enhancer.core.common_helper import get_first, get_last
from face_enhancer.core.types import LogLevel


def init(log_level : LogLevel) -> None:
	basicConfig(format = '%(message)s')
	get_package_logger().setLevel(choices.log_level_set.get(log_level))


def get_package_logger() -> Logger:
	return getLogger('face_enhancer')
